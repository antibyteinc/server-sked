...
<script>
    ...
    export default {
        ...
        components: {
            HeaderPage, MainPage, FooterPage
        }
    }
</script>
<style>
    :root {
        ...
        --fontHand: 'Gochi Hand', cursive;
        /*colors*/
        --mainDark: #24292e;
        --mainWhite: #f4f4f4;
        --mainSilver: #7d848b;
        /*transitions*/
        --transDef: all .3s ease;
    }
    * {
    ...
    .button_constructor:hover {
        background-color: var(--mainDark);
        color: var(--mainWhite);
    }
    .button_constructor:active {
        transform: scale(0.95);
    }
    /* --- sections --- */
    .title {
