    ...
    <div class="wrapper__teacher">
        <div class="panel panel-default col-md-8 col-md-offset-2">
            ...
            <div class="teacher-form">
                <input type="text" placeholder="Призвище" v-model="newTeacher.surname" @keyup.enter="addTeacher">
                <input type="text" placeholder="Ім'я" v-model="newTeacher.name" @keyup.enter="addTeacher">
                <input type="text" placeholder="По-батькові" v-model="newTeacher.patronymic" @keyup.enter="addTeacher">
                <input type="text" placeholder="Звання" v-model="newTeacher.rankTeacher" @keyup.enter="addTeacher">
                <input type="date" placeholder="Дата народження" v-model="newTeacher.birthday" @keyup.enter="addTeacher">
                <input type="text" placeholder="Конт. телефон" v-model="newTeacher.phoneNumber" @keyup.enter="addTeacher">
                <input type="text" placeholder="Пошта" v-model="newTeacher.mail" @keyup.enter="addTeacher">
