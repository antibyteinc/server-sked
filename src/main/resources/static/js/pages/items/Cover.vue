<template>
    <div>
        ...
        <div v-else>
            <input type="text" placeholder="Назва закладу" v-model="institutionPage.name" @keyup.enter="update">
            <textarea name="" id="" cols="30" rows="10" placeholder="Опис"
                      v-model="institutionPage.description" @keyup.enter="update"></textarea>
            <input type="text" placeholder="Веб-сайт" v-model="institutionPage.site" @keyup.enter="update">
            <input type="text" placeholder="Контактний телефон" v-model="institutionPage.phone" @keyup.enter="update">
            <input type="text" placeholder="Пошта" v-model="institutionPage.mail" @keyup.enter="update">
    ...
    export default {
        data() {
            return {
                ...
                institutionPageApi: this.$resource("/institution-cover/edit{/id}"),
                institutionPage: {}
            }
        },
        created() {
