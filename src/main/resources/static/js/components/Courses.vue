    ...
    <div class="wrapper__course" v-if="faculties.length > 0">
        <div class="courses" v-if="courses.length > 0">
            <div class="course" v-for="course in courses">
                ...
                <div class="course-footer">
                    <departments :course="course"></departments>
                </div>
            </div>
        </div>
        ...
        <div class="course-form">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Додати курс" v-model="newCourse.name">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                courseApi: this.$resource("/courses{/id}"),
